...
//routes for units
Route::get('units/{unit_id}', 'UnitsController@show')->middleware('auth', 'verfied');
Route::put('units/{unit_id}', 'UnitsController@update')->middleware('auth', 'verfied');
Route::post('units/add', 'UnitsController@add_unit')->middleware('auth', 'verfied');
Route::post('units/add-multiple', 'UnitsController@add_multiple_rooms')->middleware('auth', 'verfied');
...
//routes for payments
Route::get('units/{unit_id}/tenants/{tenant_id}/payments/{payment_id}', 'PaymentController@show')->name('show-payment')->middleware('auth', 'verfied');
Route::post('/payments', 'PaymentController@store')->middleware('auth', 'verfied');
Route::get('/payments/all', 'PaymentController@index')->name('show-all-payments')->middleware('auth', 'verfied');
Route::get('/payments/search', 'PaymentController@index')->middleware('auth', 'verfied');
Route::delete('/payments/{payment_id}', 'PaymentController@destroy')->middleware('auth', 'verfied');

Route::get('/units/{unit_id}/tenants/{tenant_id}/payments/{payment_id}/dates/{payment_created}/export', 'TenantController@export')->middleware('auth', 'verfied');

Route::get('/units/{unit_id}/tenants/{tenant_id}/billings/export', 'TenantController@exportBills')->middleware('auth', 'verfied');

//routes for tenants
Route::get('/units/{unit_id}/tenants/{tenant_id}', 'TenantController@show')->name('show-tenant')->middleware('auth', 'verfied');
Route::post('/tenants', 'TenantController@store')->middleware('auth', 'verfied');
Route::get('/units/{unit_id}/tenants/{tenant_id}/edit', 'TenantController@edit')->middleware('auth', 'verfied');
Route::put('/units/{unit_id}/tenants/{tenant_id}/', 'TenantController@update')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenants/{tenant_id}', 'TenantController@moveout')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenants/{tenant_id}/renew', 'TenantController@renew')->middleware('auth', 'verfied');
Route::delete('/tenants/{tenant_id}', 'TenantController@destroy')->middleware('auth', 'verfied');
...
//step1
Route::get('/units/{unit_id}/tenant-step1', 'TenantController@createTenantStep1')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenant-step1', 'TenantController@postTenantStep1')->middleware('auth', 'verfied');

//step2
Route::get('/units/{unit_id}/tenant-step2', 'TenantController@createTenantStep2')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenant-step2', 'TenantController@postTenantStep2')->middleware('auth', 'verfied');

//step3
Route::get('/units/{unit_id}/tenant-step3', 'TenantController@createTenantStep3')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenant-step3', 'TenantController@postTenantStep3')->middleware('auth', 'verfied');

//step-4
Route::get('/units/{unit_id}/tenant-step4', 'TenantController@createTenantStep4')->middleware('auth', 'verfied');
Route::post('/units/{unit_id}/tenant-step4', 'TenantController@postTenantStep4')->middleware('auth', 'verfied');

//routes for billings
Route::get('/units/{unit_id}/tenants/{tenant_id}/billings', 'TenantController@show_billings')->name('show-billings')->middleware('auth', 'verfied');
Route::post('/tenants/billings', 'TenantController@add_billings')->name("add-billings")->middleware('auth', 'verfied');
Route::post('/tenants/billings-post', 'TenantController@post_billings')->middleware('auth', 'verfied');


Route::get('/units/{unit_id}/tenants/{tenant_id}/payments', 'TenantController@show_payments')->name('show-payments')->middleware('auth', 'verfied');

//route for searching tenant
Route::get('/tenants/search', 'TenantController@search')->middleware('auth', 'verfied');

//routes for investors
Route::get('/units/{unit_id}/unit_owners/{unit_owner_id}', 'UnitOwnersController@show')->name('show-investor')->middleware('auth', 'verfied');
Route::post('/units', 'UnitsController@store')->middleware('auth', 'verfied');
Route::delete('/units/{$unit_id}', 'UnitsController@destroy')->middleware('auth', 'verfied');

//route for searching investors
Route::get('/unit_owners/{unit_owner_id}', 'UnitOwnersController@search')->middleware('auth', 'verfied');

//route for users
Route::get('/users/search', 'UserController@search')->middleware('auth', 'verfied');
Route::get('/users/{user_id}', 'UserController@show')->middleware('auth', 'verfied');
Route::post('/users', 'UserController@store')->middleware('auth', 'verfied');
Route::get('/users/{user_id}/edit', 'UserController@edit')->middleware('auth', 'verfied');
Route::put('users/{user_id}', 'UserController@update')->middleware('auth', 'verfied');
Route::delete('/users/{user_id}', 'UserController@destroy')->middleware('auth', 'verfied');

Route::get('logout', '\App\Http\Controllers\Auth\LoginController@logout')->middleware('auth', 'verfied');
...
//concerns
Route::post('/concerns', 'ConcernController@store')->middleware('auth', 'verfied');

//show concerns 
Route::get('/units/{unit_id}/tenants/{tenant_id}/concerns/{concern_id}', 'ConcernController@show')->middleware('auth', 'verfied');

//update concerns
Route::put('/concerns/{concern_id}', 'ConcernController@update')->middleware('auth', 'verfied');

Route::post('/billings', 'BillingController@store')->middleware('auth', 'verfied');


//routes for personnels
Route::post('/personnels', 'PersonnelController@store')->middleware('auth', 'verfied');
