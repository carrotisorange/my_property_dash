...
Route::get('/', function(Request $request){
   ...
   if(count($property) > 1){
    ...
    $movein_rate->dataset('', 'line', [
                                                                number_format((($movein_rate_1)-($movein_rate_2 + $movein_rate_3 + $movein_rate_4 + $movein_rate_5 + $movein_rate_6))/$leasing_units->count() * -200,2),
                                                                number_format((($movein_rate_2)-($movein_rate_1 + $movein_rate_3 + $movein_rate_4 + $movein_rate_5 + $movein_rate_6))/$leasing_units->count() * -200,2),
                                                                number_format((($movein_rate_3)-($movein_rate_1 + $movein_rate_2 + $movein_rate_4 + $movein_rate_5 + $movein_rate_6))/$leasing_units->count() * -200,2),
                                                                number_format((($movein_rate_4)-($movein_rate_1 + $movein_rate_2 + $movein_rate_3 + $movein_rate_5 + $movein_rate_6))/$leasing_units->count() * -200,2),
                                                                number_format((($movein_rate_5)-($movein_rate_1 + $movein_rate_2 + $movein_rate_3 + $movein_rate_4 + $movein_rate_6))/$leasing_units->count() * -200,2),
                                                                number_format((($movein_rate_6)-($movein_rate_1 + $movein_rate_2 + $movein_rate_3 + $movein_rate_4 + $movein_rate_5))/$leasing_units->count() * -200,2),
                                                            ])
    ->color("rgb(0, 0, 0)")
