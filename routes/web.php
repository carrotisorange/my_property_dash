...
Route::get('/', function(Request $request){
   ...
   if(count($property) > 1){
    ...
    $movein_rate->dataset('Occupancy Rate: ', 'line', [
        number_format(($all_active_tenants->count()-($movein_rate_2 == 0 ? 0: $movein_rate_2 + $movein_rate_3 + $movein_rate_4 + $movein_rate_5 + $movein_rate_6))/$leasing_units->count() * 100,2),
