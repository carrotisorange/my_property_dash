            ...
            <tr>
              ...
              <td>{{ $item->first_name.' '.$item->last_name }} 
                ...
                ?>
                  ...
                  @else
                    <input form="add_billings" class="col-md-6" type="number" name="amt{{ $amt_ctr++ }}" step="0.01"  value="{{ number_format($prorated_monthly_rent, 5) }}" oninput="this.value = Math.abs(this.value)">
                  @endif
                </td>
           </tr>
           @endforeach
