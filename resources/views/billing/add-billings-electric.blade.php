      ...
      <div id="content">
        ...
        <form id="add_billings" action="/tenants/billings-post" method="POST">
           ...
           <input class="form-control" type="hidden" form="add_billings" name="ctr" value="{{ $ctr++ }}" readonly>     
            ...
            <input class="form-control" type="hidden" form="add_billings" name="desc{{ $desc_ctr++ }}" value="Electricity" readonly>
            <tr>
              <th class="text-center" >{{ $current_bill_no++ }}</th>
                ...
                <td>
                    <input form="add_billings" class="col-md-6" type="number" step="0.01" name="amt{{ $amt_ctr++ }}" value="0" oninput="this.value = Math.abs(this.value)">
                </td>
           </tr>
           @endforeach
        </table>
        ...
        <p class="text-right">
            ...
            <button type="submit" form="add_billings" id="addBillsButton" class="d-none d-sm-inline-block btn btn-sm btn-purple shadow-sm"  onclick="return confirm('Are you sure you want to perform this action?');"><i class="fas fa-check"></i> Add Bills</button>
        </p>
        </div>
