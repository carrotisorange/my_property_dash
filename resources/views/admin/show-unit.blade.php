  ...
  <div class="col-md-12">
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="unit" role="tabpanel" aria-labelledby="nav-unit-tab">
        @if(Auth::user()->user_type === 'manager' )
        <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#editUnit" data-whatever="@mdo"><i class="fas fa-edit fa-sm text-white-50"></i> Edit</button> 
      @endif 
