      ...
      <div id="content">
        ...
        <div class="row">
            ...
            <p class="text-right">   
                ...
                <button type="submit" form="addTenantForm3" class="d-none d-sm-inline-block btn btn-sm btn-purple shadow-sm" ><i class="fas fa-arrow-right fa-sm text-white-50"></i> Next</button>
            </p>
