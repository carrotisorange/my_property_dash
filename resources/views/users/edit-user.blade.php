              ...
              <div class="table-responsive">
                ...
                <tr>
                 ...
                 <p class="text-right">
                  ...
                  <button form="editUserForm" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-purple shadow-sm" onclick="return confirm('Are you sure you want perform this action?');"><i class="fas fa-check fa-sm text-white-50"></i> Update Profile</button>
                </p>
             </div>
           </div>
