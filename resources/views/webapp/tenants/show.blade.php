    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        @endif
         ...
         <a class="nav-item nav-link" id="nav-payments-tab" data-toggle="tab" href="#payments" role="tab" aria-controls="nav-payments" aria-selected="true"><i class="fas fa-money-bill"></i> Payments <span class="badge badge-primary badge-counter">{{ $collections_count }}</span></a>
  ...
  @enderror
    ...
    <button class="btn btn-primary shadow-sm btn-user btn-block" form="uploadImageForm"><i class="fas fa-upload fa-sm text-white-50"></i> Upload Image </button>
           ...
           <tbody>
             ...
             <tr>
               ...
               <td>{{ Carbon\Carbon::parse($item->date_reported)->format('M d Y') }}</td>
                 ...
                 <td ><a href="/property/{{ $property->property_id }}/tenant/{{ $item->tenant_id }}/concern/{{ $item->concern_id }}">{{ $item->concern_item }}</a></td>
                 <td>
      ...
      <div class="tab-pane fade" id="contracts" role="tabpanel" aria-labelledby="nav-contracts-tab">
        ...
        <a  href="#" class="btn btn-primary" data-toggle="modal" data-target="#addContract" data-whatever="@mdo"><i class="fas fa-plus fa-sm text-white-50"></i> Add</a>  
              ...
              <tbody>
               ...
               <tr>
                ...
                <td colspan="5">
                  ...
                  <a title="Delete" href="#" class="btn btn-danger" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-trash-alt"></i> </a>
                  <a title="Edit" href="#" class="btn btn-warning" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-edit"></i> </a>
                  <a title="Print" href="#" class="btn btn-primary" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-print"></i> </a>
                  <a title="Preterminate" href="#" class="btn btn-danger" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-hourglass-end"></i> </a>
                  <a title="Extend" href="#" class="btn btn-primary" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-external-link-alt"></i> </a>
                  <a title="View" href="#" class="btn btn-success" data-toggle="modal" data-target="#preterminateContract" data-whatever="@mdo"><i class="fas fa-id-badge"></i> </a>
                  </div>
                </td>
              ...
              <div class="col">
                ...
                <div class="alert alert-success alert-dismissable custom-success-box">
                    ...
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        <strong><i class="fas fa-check"></i>  By default, the password would be the mobile number of the tenant. <br> Please ask the tenant to immediately access the portal and change the password..</strong>
...
@include('webapp.tenants.show_includes.contracts.preterminate')
