...
<div class="row align-items-center py-4">
  <div class="col-lg-6 col-7">
    <h6 class="h2 text-dark d-inline-block mb-0">Electricity Bills</h6>
    
  </div>
  <div class="col-lg-6 col-5 text-right">
    <form id="periodCoveredForm" action="/property/{{ $property->property_id }}/bills/electric/{{ Carbon\Carbon::parse($updated_billing_start)->format('Y-m-d') }}-{{ Carbon\Carbon::parse($updated_billing_end)->format('Y-m-d') }}/" method="POST">
      @csrf
      Period Covered 
...
<div class="row">
  ...
  <br>
  <p class="text-right">
    <a href="/property/{{ $property->property_id }}/bills" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-times"></i> Cancel</a>
    <button type="submit" form="add_billings" id="addBillsButton" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  onclick="return confirm('Are you sure you want to perform this action?');"><i class="fas fa-check"></i> Submit</button>
  </p>
