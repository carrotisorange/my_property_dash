              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <div class="form-group">
                        <input form="loginForm" id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="text-center">
                    @if (Route::has('password.request'))
                        <a class="small btn-link" href="/password/reset">
